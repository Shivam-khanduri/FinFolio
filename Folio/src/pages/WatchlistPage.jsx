...
const WatchlistPage = () => {
  ...
  // ✅ Show notification when stock is removed
        ...
        {watchlist.length === 0 ? (
          ...
          <div className="space-y-4 max-w-4xl">
            {watchlist.map((stock) => (
              <div
                key={stock.symbol}
                className="bg-blue-100 dark:bg-blue-900 text-blue-900 dark:text-blue-100 rounded-xl shadow p-4 flex justify-between items-center"
              >
                <div>
