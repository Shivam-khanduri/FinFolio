      ...
      <nav className="space-x-4 flex items-center">
        ...
        {isLoggedIn ? (
          <>
            ...
            <button onClick={handleLogout} className="px-4 py-2 text-sm bg-blue-600  text-white dark:bg-blue-600 dark:text-white text-gray-700 rounded-xl hover:bg-gray-400 dark:hover:bg-gray-500 transition">Logout</button>
          </>
        ) : (
          <>
